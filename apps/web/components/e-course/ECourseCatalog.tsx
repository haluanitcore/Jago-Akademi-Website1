...
const courses: Course[] = [
  ...
  },
  {
    id: "ds-2",
    category: "data-science",
    title: "Data Visualization dengan Tableau",
...
const levelColors: Record<Course["level"], string> = {
  Pemula: "text-emerald-400 bg-emerald-400/10 border-emerald-400/20",
  Menengah: "text-[#00d4ff] bg-[#00d4ff]/10 border-[#00d4ff]/20",
  Lanjutan: "text-[#ff0066] bg-[#ff0066]/10 border-[#ff0066]/20",
};
    ...
    <section className="py-16 border-t border-[#1f1f1f]">
      <div className="max-w-[1152px] mx-auto px-8">
        ...
        <div className="text-center mb-3">
          <h2 className="text-2xl font-bold font-display text-[#f5f5f5]">
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    isActive
                      ? "bg-[#00d4ff] border-[#00d4ff] text-[#0d0d0d]"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {filtered.map((course) => (
            <Link
              ...
              className="group bg-[#141414] border border-[#262626] rounded-xl p-4 flex flex-col gap-3 hover:border-[#00d4ff]/30 hover:bg-[#00d4ff]/3 transition-all duration-200"
            >
              {/* Thumbnail placeholder */}
              <div className="aspect-video rounded-lg bg-gradient-to-br from-[#0d1a1f] to-[#1a1a1a] border border-[#1f1f1f] flex items-center justify-center">
                <div className="text-center">
                  <p className="text-[#00d4ff] text-xs font-mono opacity-50">PREVIEW</p>
                </div>
              </div>
              ...
              {/* Title */}
              <h3 className="text-[#f5f5f5] text-sm font-semibold leading-snug group-hover:text-[#00d4ff] transition-colors line-clamp-2">
                {course.title}
              </h3>

              {/* Instructor */}
              <p className="text-[#525252] text-xs">{course.instructor}</p>

              {/* Meta */}
              <div className="flex items-center gap-3 text-[#525252] text-xs mt-auto pt-2 border-t border-[#1f1f1f]">
