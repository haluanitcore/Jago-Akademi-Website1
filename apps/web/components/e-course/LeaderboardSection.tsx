...
// Reserved for TASK-097 (gamification/XP, Phase 6, BL-25). Not imported
// anywhere while features.gamification is OFF — sample data below must be
// replaced with real users before this is ever rendered.
